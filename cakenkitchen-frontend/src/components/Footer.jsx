    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-section">
          <h3>Cake & Kitchen</h3>
          <p>Delicious, freshly baked cakes made with high-quality ingredients. Perfect for all your special celebrations.</p>
        </div>
        ...
        <div className="footer-section">
          <h3>Contact Us</h3>
          <p>Dhangadhi, Kailali, Sudurpaschim</p>
          <p>Phone: +977 980-6461461</p>
          <p>Email: support@cakenkitchen.com</p>
          
          <div className="footer-social-container">
            <a href="https://wa.me/9779806461461" target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Chat on WhatsApp">
              <WhatsAppIcon />
              WhatsApp
            </a>
            
            <a href="https://www.facebook.com/razan.dhanusha" target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Visit Instagram">
              <InstagramIcon />
              Instagram
            </a>
            
            <a href="https://www.facebook.com/razan.dhanusha" target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Visit Facebook">
              <FacebookIcon />
              Facebook
            </a>
          </div>
