    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-section footer-newsletter-section">
          <h3>Subscribe to Sweet Updates</h3>
          <p style={{ marginTop: '0.5rem', marginBottom: '1.2rem' }}>
            Join our newsletter for exclusive recipes and fresh discount codes!
          </p>
        ...
        <div className="footer-section">
          ...
          <div style={{ marginTop: '1.2rem', display: 'flex', gap: '1.2rem', alignItems: 'center' }}>
            <a
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', color: '#F9A8A4', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}
              title="Chat on WhatsApp"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#F9A8A4" style={{ transition: 'fill 0.2s' }}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', color: '#FDE8E0', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}
              title="Visit Instagram"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#FDE8E0" style={{ transition: 'fill 0.2s' }}>
