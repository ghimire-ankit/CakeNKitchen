      ...
      <div className="footer-main wrap">
        ...
        <div className="foot-brand">
          ...
          <div className="foot-socials">
            <a href="https://facebook.com/cakenkitchen" target="_blank" rel="noreferrer" aria-label="Facebook" className="foot-social">
            ...
            <a href="https://wa.me/977980123456" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="foot-social">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="foot-col">
          ...
          <div className="foot-contacts-list">
            ...
            <div className="foot-contact-item align-top">
              ...
              <span>123 Main Street,<br />Dhangadhi, Kailali, Nepal</span>
            </div>
          </div>

          <div className="foot-hours-mini">
            <p><strong>Mon–Sat:</strong> 7:00 AM – 9:30 PM</p>
